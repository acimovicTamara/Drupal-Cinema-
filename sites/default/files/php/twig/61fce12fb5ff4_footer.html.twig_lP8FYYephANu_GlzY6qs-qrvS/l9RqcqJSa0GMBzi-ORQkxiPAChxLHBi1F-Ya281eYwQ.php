...
class __TwigTemplate_fb18bbb5dc6c8451dc0779578c42ac3e59d8eccfe4581715888f42b61318da60 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"footer-bottom-last\">
      ...
      {% if all_icons_show %}
        <div class=\"footer-social-icons\">
          {% include '@vani/template-parts/social-icons.html.twig' %}
        </div>
      {% endif %}
      </div> <!--/.social icons -->
    </div> <!-- /.container -->
...
{% endif %}
", "@vani/template-parts/footer.html.twig", "C:\\xampp\\htdocs\\drupal_cinema\\themes\\vani\\templates\\template-parts\\footer.html.twig");
    }
