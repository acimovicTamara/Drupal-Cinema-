...
class __TwigTemplate_7024a8df7fec744283dbcd191bb3e60e3f6a93d87fb6b58d193f4ee5034577e8 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    ...
    {% for item in items %}
      ...
      {% if menu_level == 0 and item.is_collapsed %}
        ...
        <a href=\"{{ item.url }}\">{{ item.title }} <span class=\"dropdown-arrow\">+</span></a>
  ...
  {% endif %}
{% endmacro %}
", "themes/vani/templates/navigation/menu--main.html.twig", "C:\\xampp\\htdocs\\drupal_cinema\\themes\\vani\\templates\\navigation\\menu--main.html.twig");
    }
